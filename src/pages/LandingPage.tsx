...
<p className="text-white/90 dark:text-white/90 text-base md:text-lg leading-relaxed max-w-xl mt-3">Start for <b>free</b> with just your email...</p>
                {!user ? (
                  <div className="space-y-2 max-w-[300px] mt-6">
